...
(function (global, factory) {
  ...
  var ImageTexture = /*#__PURE__*/function (_Texture) {
    ...
    var _super = _createSuper(ImageTexture);
  ...
  var TextTextureRendererAdvanced = /*#__PURE__*/function () {
    function TextTextureRendererAdvanced(stage, canvas, settings) {
      _classCallCheck(this, TextTextureRendererAdvanced);
    ...
    _createClass(TextTextureRendererAdvanced, [{
      key: "getPrecision",
      value: function getPrecision() {
        return this._settings.precision;
      }
      ...
      key: "setFontProperties",
      value: function setFontProperties() {
        var font = Utils.isSpark ? this._stage.platform.getFontSetting(this) : this._getFontSetting();
      ...
      value: function _calculateRenderInfo() {
        ...
        if (renderInfo.wordBreak) {
          text = text.reduce(function (acc, t) {
            _newArrowCheck(this, _this3);

            return acc.concat(this.wordBreak(t, wrapWidth, renderInfo.baseFont));
          }.bind(this), []);
          this.resetFontStyle();
        }
        ...
        var _iterator3 = _createForOfIteratorHelper(renderInfo.lines),
            _step3;
        ...
        var _iterator4 = _createForOfIteratorHelper(renderInfo.lines),
            _step4;

        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var _l3 = _step4.value;
            _l3.width = _l3.text.reduce(function (acc, t) {
              _newArrowCheck(this, _this3);
        ...
        renderInfo.width = this._settings.w != 0 ? this._settings.w * precision : Math.max.apply(Math, _toConsumableArray(renderInfo.lines.map(function (l) {
          _newArrowCheck(this, _this3);
        ...
        if (renderInfo.maxLines && renderInfo.lineNum > renderInfo.maxLines && renderInfo.maxLinesSuffix) {
          ...
          var lastLineText = text.filter(function (t) {
            _newArrowCheck(this, _this3);

            return t.lineNo == index;
          }.bind(this));
          var _suffix = renderInfo.maxLinesSuffix;
          _suffix = this.tokenize(_suffix);
          _suffix = this.parse(_suffix);
          _suffix = this.measure(_suffix, renderInfo.letterSpacing, renderInfo.baseFont)[0];
          _suffix.lineNo = index;

          if (lastLineText.length) {
            _suffix.x = lastLineText[lastLineText.length - 1].x + lastLineText[lastLineText.length - 1].width;
          } else {
            _suffix.x = 0;
          }

          lastLineText.push(_suffix);

          var _w = lastLineText.reduce(function (acc, t) {
            _newArrowCheck(this, _this3);
          ...
          while (_w > renderInfo.width || lastLineText[lastLineText.length - 2].text == ' ') {
            ...
            _w = lastLineText.reduce(function (acc, t) {
              _newArrowCheck(this, _this3);

              return acc + t.width;
            }.bind(this), 0);
            var prev = lastLineText[lastLineText.length - 2] || {
              x: 0,
              width: 0
            };
            _suffix.x = prev.x + prev.width;
        ...
        if (renderInfo.textAlign == 'center') {
          var _iterator5 = _createForOfIteratorHelper(renderInfo.lines),
              _step5;
          ...
          var _iterator6 = _createForOfIteratorHelper(renderInfo.lines),
              _step6;
      ...
      value: function _draw() {
        ...
        var _iterator7 = _createForOfIteratorHelper(renderInfo.lines),
            _step7;
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            var _iterator8 = _createForOfIteratorHelper(line.text),
                _step8;
            ...
            try {
              for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                ...
                if (t.letters) {
                  var _iterator9 = _createForOfIteratorHelper(t.letters),
                      _step9;

                  try {
                    for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
                      var _l4 = _step9.value;
        ...
        renderInfo.lines = renderInfo.lines.map(function (l) {
          var _this5 = this;

          _newArrowCheck(this, _this4);

          return l.text.reduce(function (acc, v) {
            _newArrowCheck(this, _this5);
      ...
      value: function measure(parsed) {
        ...
        var _iterator10 = _createForOfIteratorHelper(parsed),
            _step10;
        ...
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
            ...
            if (letterSpacing > 0) {
              p.letters = p.text.split('').map(function (l) {
              ...
              var _iterator11 = _createForOfIteratorHelper(p.letters),
                  _step11;
      ...
      value: function wordBreak(word, width, baseFont) {
        ...
        if (!word.letters) {
          ...
          var _iterator12 = _createForOfIteratorHelper(word.letters),
              _step12;
    ...
    return TextTextureRendererAdvanced;
  }();
  ...
  var SourceTexture = /*#__PURE__*/function (_Texture) {
    ...
    var _super = _createSuper(SourceTexture);
  ...
  var ElementChildList = /*#__PURE__*/function (_ObjectList) {
    ...
    var _super = _createSuper(ElementChildList);
          ...
          if (!_this2.hasOwnProperty(propName)) {
            ...
            Object.defineProperty(_this2, propName, {
              set: function set(value) {
                ...
                var _iterator = _createForOfIteratorHelper(_this2["__prop_bindings_".concat(propName)]),
                    _step;

                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    var _step$value = _step.value,
                        __obj = _step$value.__obj,
                        __prop = _step$value.__prop,
                        __func = _step$value.__func;
  ...
  var WebGLCoreQuadList = /*#__PURE__*/function (_CoreQuadList) {
    ...
    var _super = _createSuper(WebGLCoreQuadList);
  ...
  var WebGLCoreQuadOperation = /*#__PURE__*/function (_CoreQuadOperation) {
    ...
    var _super = _createSuper(WebGLCoreQuadOperation);
  ...
  var WebGLCoreRenderExecutor = /*#__PURE__*/function (_CoreRenderExecutor) {
    ...
    var _super = _createSuper(WebGLCoreRenderExecutor);
  ...
  var WebGLShader = /*#__PURE__*/function (_Shader) {
    ...
    var _super = _createSuper(WebGLShader);
  ...
  var DefaultShader = /*#__PURE__*/function (_WebGLShader) {
    _inherits(DefaultShader, _WebGLShader);

    var _super = _createSuper(DefaultShader);
  ...
  var C2dCoreQuadList = /*#__PURE__*/function (_CoreQuadList) {
    ...
    var _super = _createSuper(C2dCoreQuadList);
  ...
  var C2dCoreQuadOperation = /*#__PURE__*/function (_CoreQuadOperation) {
    ...
    var _super = _createSuper(C2dCoreQuadOperation);
  ...
  var C2dCoreRenderExecutor = /*#__PURE__*/function (_CoreRenderExecutor) {
    ...
    var _super = _createSuper(C2dCoreRenderExecutor);
  ...
  var C2dShader = /*#__PURE__*/function (_Shader) {
    ...
    var _super = _createSuper(C2dShader);
  ...
  var DefaultShader$1 = /*#__PURE__*/function (_C2dShader) {
  ...
  var C2dRenderer = /*#__PURE__*/function (_Renderer) {
    ...
    var _super = _createSuper(C2dRenderer);
  ...
  var SparkShader = /*#__PURE__*/function (_WebGLShader) {
    _inherits(SparkShader, _WebGLShader);

    var _super = _createSuper(SparkShader);

    function SparkShader() {
      _classCallCheck(this, SparkShader);

      return _super.apply(this, arguments);
    }

    _createClass(SparkShader, [{
      key: "enableAttribs",
      value: function enableAttribs() {
        var gl = this.gl;
        gl.vertexAttribPointer(this._attrib("aVertexPosition"), 2, gl.FLOAT, false, 20, 0);
  ...
  var SparkRenderer = /*#__PURE__*/function (_WebGLRenderer) {
    _inherits(SparkRenderer, _WebGLRenderer);

    var _super = _createSuper(SparkRenderer);

    function SparkRenderer(stage) {
      _classCallCheck(this, SparkRenderer);

      return _super.call(this, stage);
    }

    _createClass(SparkRenderer, [{
      key: "_createDefaultShader",
      value: function _createDefaultShader(ctx) {
      ...
      value: function createCoreRenderExecutor(ctx) {
        ...
        var ret = _get(_getPrototypeOf(SparkRenderer.prototype), "createCoreRenderExecutor", this).call(this, ctx);
    ...
    _createClass(WebPlatform, [{
      ...
      value: function handleKtxLoad(cb, src) {
        ...
        return function () {
          ...
          var formats = Object.values(self.stage.renderer.getCompressedTextureExtensions()).filter(function (obj) {
            _newArrowCheck(this, _this2);
  ...
  var RectangleTexture = /*#__PURE__*/function (_Texture) {
    ...
    var _super = _createSuper(RectangleTexture);
    ...
    _createClass(Application, [{
      ...
      value: function fireBottomUpHoverHandler(obj) {
        ...
        if (target !== this.__hoveredChild) {
          (function () {
            ...
            var _iterator2 = _createForOfIteratorHelper(diffBranch),
                _step2;
      ...
      value: function _withinClickableRange(affectedChildren, cursorX, cursorY) {
        ...
        var _loop = function _loop() {
          ...
          var precision = _this8.stage.getRenderPrecision();
          ...
          if (child.parent.core._scissor) {
            ...
            if (!_this8._testCollision.apply(_this8, [cursorX, cursorY].concat(_toConsumableArray(scissor)))) return "continue";
          }
      ...
      value: function _destroy() {
        ...
        if (this.__keypressTimers.size) {
          var _iterator3 = _createForOfIteratorHelper(this.__keypressTimers.values()),
              _step3;
  ...
  var StaticCanvasTexture = /*#__PURE__*/function (_Texture) {
    ...
    var _super = _createSuper(StaticCanvasTexture);
  ...
  var ObjectListProxy = /*#__PURE__*/function (_ObjectList) {
    ...
    var _super = _createSuper(ObjectListProxy);
  ...
  var ObjectListWrapper = /*#__PURE__*/function (_ObjectListProxy) {
    ...
    var _super = _createSuper(ObjectListWrapper);
  ...
  var HtmlTexture = /*#__PURE__*/function (_Texture) {
    ...
    var _super = _createSuper(HtmlTexture);
  ...
  var StaticTexture = /*#__PURE__*/function (_Texture) {
    ...
    var _super = _createSuper(StaticTexture);
  ...
  var ListComponent = /*#__PURE__*/function (_Component) {
    ...
    function ListComponent(stage) {
      ...
      _this = _super.call(this, stage);
      _this._wrapper = _get((_thisSuper = _assertThisInitialized(_this), _getPrototypeOf(ListComponent.prototype)), "_children", _thisSuper).a({});
  ...
  var ListItems = /*#__PURE__*/function (_ObjectListWrapper) {
    ...
    var _super2 = _createSuper(ListItems);
  ...
  var LinearBlurShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(LinearBlurShader);
  ...
  var BoxBlurShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(BoxBlurShader);
  ...
  var BlurShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(BlurShader);
  ...
  var FastBlurComponent = /*#__PURE__*/function (_Component) {
    ...
    var _super = _createSuper(FastBlurComponent);
  ...
  var BloomBaseShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super2 = _createSuper(BloomBaseShader);
  ...
  var WebGLGrayscaleShader = /*#__PURE__*/function (_WebGLDefaultShader) {
    ...
    var _super = _createSuper(WebGLGrayscaleShader);
  ...
  var C2dGrayscaleShader = /*#__PURE__*/function (_C2dDefaultShader) {
    ...
    var _super2 = _createSuper(C2dGrayscaleShader);
  ...
  var DitheringShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(DitheringShader);
  ...
  var CircularPushShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(CircularPushShader);
  ...
  var InversionShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(InversionShader);
  ...
  var OutlineShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(OutlineShader);
  ...
  var PixelateShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(PixelateShader);
  ...
  var RadialFilterShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(RadialFilterShader);
    ...
    _createClass(RadialFilterShader, [{
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _get(_getPrototypeOf(RadialFilterShader.prototype), "setupUniforms", this).call(this, operation);
  ...
  var RoundedRectangleShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    function RoundedRectangleShader(context) {
      ...
      _this._stroke = 0;
      _this._fc = 0x00ffffff;
      _this._fillColor = _this._getNormalizedColor(0xffffffff);
      _this._strokeColor = _this._getNormalizedColor(0x00ffffff);
      return _this;
    }
  ...
  var FadeOutShader = /*#__PURE__*/function (_DefaultShader) {
    _inherits(FadeOutShader, _DefaultShader);

    var _super = _createSuper(FadeOutShader);

    function FadeOutShader(context) {
      var _this;

      _classCallCheck(this, FadeOutShader);
    ...
    _createClass(FadeOutShader, [{
      ...
      value: function setupUniforms(operation) {
        ...
        _get(_getPrototypeOf(FadeOutShader.prototype), "setupUniforms", this).call(this, operation);
  ...
  var VignetteShader = /*#__PURE__*/function (_DefaultShader) {
    _inherits(VignetteShader, _DefaultShader);

    var _super = _createSuper(VignetteShader);

    function VignetteShader(context) {
      var _this;

      _classCallCheck(this, VignetteShader);
    ...
    _createClass(VignetteShader, [{
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _get(_getPrototypeOf(VignetteShader.prototype), "setupUniforms", this).call(this, operation);
  ...
  var SpinnerShader = /*#__PURE__*/function (_DefaultShader) {
    _inherits(SpinnerShader, _DefaultShader);

    var _super = _createSuper(SpinnerShader);

    function SpinnerShader(ctx) {
      var _this;

      _classCallCheck(this, SpinnerShader);
      ...
      _this._angle = 0.5;
      _this._smooth = 0.005;
      _this._color = 0xffffffff;
      _this._backgroundColor = 0xff000000;
  ...
  var HoleShader = /*#__PURE__*/function (_DefaultShader) {
    _inherits(HoleShader, _DefaultShader);

    var _super = _createSuper(HoleShader);

    function HoleShader(context) {
      var _this;

      _classCallCheck(this, HoleShader);
  ...
  var RadialGradientShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(RadialGradientShader);
    ...
    _createClass(RadialGradientShader, [{
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _get(_getPrototypeOf(RadialGradientShader.prototype), "setupUniforms", this).call(this, operation);
  ...
  var Light3dShader = /*#__PURE__*/function (_DefaultShader) {
    ...
    var _super = _createSuper(Light3dShader);
  ...
  var PerspectiveShader = /*#__PURE__*/function (_DefaultShader) {
    _inherits(PerspectiveShader, _DefaultShader);

    var _super = _createSuper(PerspectiveShader);

    function PerspectiveShader(ctx) {
      var _this;

      _classCallCheck(this, PerspectiveShader);
    ...
    _createClass(PerspectiveShader, [{
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _get(_getPrototypeOf(PerspectiveShader.prototype), "setupUniforms", this).call(this, operation);
  ...
  var MagnifierShader = /*#__PURE__*/function (_DefaultShader) {
    _inherits(MagnifierShader, _DefaultShader);

    var _super = _createSuper(MagnifierShader);

    function MagnifierShader(context) {
      var _this;

      _classCallCheck(this, MagnifierShader);
  ...
  var SpinnerShader2 = /*#__PURE__*/function (_DefaultShader) {
    _inherits(SpinnerShader2, _DefaultShader);

    var _super = _createSuper(SpinnerShader2);

    function SpinnerShader2(context) {
      var _this;

      _classCallCheck(this, SpinnerShader2);
    ...
    _createClass(SpinnerShader2, [{
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _get(_getPrototypeOf(SpinnerShader2.prototype), "setupUniforms", this).call(this, operation);
  ...
  var lightning = {
    ...
    components: {
      FastBlurComponent: FastBlurComponent,
